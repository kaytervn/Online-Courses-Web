...
const EditCourseIntro = () => {
  ...
  const handleEditCourseIntro = async () => {
    try {
      setLoading(true);
      ...
      await editCourseIntro({ _id: formData._id, formData: sendFormData });
      navigate("/update-course-intro", { state: formData });
    } catch (error) {
