...
const ResetPassword = () => {
    ...
    const [showResetPasswordSuccessfully, setShowResetPasswordSuccessfully] = useState(false)
        ...
        <Container className='p-4 shadow'>
            <Row>
                <Col md='7' className='text-center text-md-start d-flex flex-column justify-content-center'>
                    ...
                    <h1 className="my-5 display-3 fw-bold ls-tight text-info-emphasis px-3">
                        ...
                        <span className="text-dark-emphasis h3">Fill in a new password for your account</span>
                    </h1>
                    ...
                    <Card style={{ marginTop: '20%' }}>
                        <Card.Body className='p-5 shadow'>
                            ...
                            <Row className='d-flex justify-content-center mt-4 '>
                                <Button className='mb-4 col-4' size='md' onClick={handleResetPassword}>Reset Password</Button>
                            </Row>
            ...
            <Modal show={showResetPasswordSuccessfully} centered>
                <Modal.Header closeButton>
                    <Modal.Title className='text-primary'>Reset password is successfully</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div style={{ textAlign: 'center' }}>
                        <img
