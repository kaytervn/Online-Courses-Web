    ...
    <Container className='p-4 shadow'>
      <Row>
        <Col md='7' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          <h1 className="my-5 display-3 fw-bold ls-tight text-info-emphasis px-3">
            ...
            <span className="text-dark-emphasis h3">Provide your account's email to reset your password</span>
          </h1>
        ...
        <Col md='4'>
          <Card style={{ marginTop: '40%' }}>
            <Card.Body className='p-5 shadow' >
              <Row >
                <h4 className='d-flex justify-content-center text-align center mb-4'>Fill in your account's email</h4>
              </Row>
              <Row>
                <Col>
              ...
              <Row className='d-flex justify-content-center mt-4 '>
                <Button className='mb-4 col-6' size='md' onClick={handleForgotPassword}>Send Email</Button>
              </Row>
      ...
      <Modal show={showDoneSend} centered>
        <Modal.Header closeButton>
          <Modal.Title className='text-primary'>Sent is successfully</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div style={{ textAlign: 'center' }}>
            <img
