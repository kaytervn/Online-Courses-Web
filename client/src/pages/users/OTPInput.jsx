            ...
            <Row>
                <Col md='7' className='text-center text-md-start d-flex flex-column justify-content-center'>
                    ...
                    <h1 className="my-5 display-3 fw-bold ls-tight text-info-emphasis px-3">
                        ...
                        <span className="text-dark-emphasis h4">The OTP code sent through <span className="text-warning fw-bold">{user.email}</span></span>
                    </h1>
                ...
                <Col md='4'>
                    <Card className='d-flex align-items-center justify-content-center' style={{ marginTop: '15%' }}>
                        <Card.Body className='p-5 shadow'>
                            <Row >
                                <h4 className='d-flex justify-content-center text-align center mb-4'>OTP Code</h4>
                            </Row>
                            <Row>
                                <OtpInput
                                    value={otp}
                                ...
                                <div className='btn-container d-flex justify-content-center mt-5'>
                                    <button className='btn btn-outline-success' onClick={handleVerify}>Verify OTP</button>
                                </div>
